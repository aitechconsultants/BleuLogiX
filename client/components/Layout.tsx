  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="bg-background sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 flex items-center justify-between" style={{ minHeight: "120px" }}>
          <Link to="/" className="flex items-center justify-center pl-6">
            <img
