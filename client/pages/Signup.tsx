          ...
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="bg-card border border-border rounded-lg p-8 space-y-6">
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30 text-amber-400 text-sm">
                Clerk authentication is not configured. Please set VITE_CLERK_PUBLISHABLE_KEY to enable signup.
              </div>
    ...
    <Layout>
      <div className="min-h-[calc(100vh-120px)] bg-background flex items-center justify-center px-4">
        <div className="w-full max-w-md">
          <SignUp routing="path" path="/signup" signInUrl="/login" redirectUrl="/generator" />
        </div>
      </div>
    </Layout>
  );
